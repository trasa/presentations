...
namespace MissileCommand.Core
{
    ...
    public class TargetingSystem  
    {
        ...
        private readonly IVectorProvider vectorProvider;
        ...
        public TargetingSystem(IVectorProvider vectorProvider, Satellite target, LaunchSite launcher, DateTime launchTime) :this(vectorProvider)
        {
            this.target = target;
        ...
        /// </remarks>
        private IList<double> ReadVectors()
        {
            return vectorProvider.GetTargetingVectors();
        }
    }
}
