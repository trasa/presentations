<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Autofill1.aspx.cs" Inherits="Autofill1" Title="ASP.NET AJAX" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Description" Runat="Server">
This page demonstrates how to consume ASMX Web services in ASP.NET AJAX clients
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" Runat="Server">
    ...
    <ajaxToolkit:AutoCompleteExtender ID="ZipCodeAutoCompleteExtender" TargetControlID="ZipCode"
        ...
        CompletionListElementID="ctl00_MainPlaceHolder_ZipCodeCompletionList" CompletionSetCount="15"
        runat="server" />
    ...
    function autoFill()
    {
        ...
        if (zip.length == 5)
            ZipCodeService.GetCityAndStateFromZipCode (zip, onGetCityAndStateCompleted);
    }
